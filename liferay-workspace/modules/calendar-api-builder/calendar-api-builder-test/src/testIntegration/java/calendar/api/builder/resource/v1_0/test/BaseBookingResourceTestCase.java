...
import calendar.api.builder.client.resource.v1_0.BookingResource;
...
public abstract class BaseBookingResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		booking.setDateOrder(regex);
		booking.setEndTime(regex);
		booking.setOrderAdress(regex);
		booking.setStartTime(regex);
		...
		Assert.assertEquals(regex, booking.getDateOrder());
		Assert.assertEquals(regex, booking.getEndTime());
		Assert.assertEquals(regex, booking.getOrderAdress());
		Assert.assertEquals(regex, booking.getStartTime());
	}

	@Test
	public void testGetBookings() throws Exception {
		Page<Booking> page = bookingResource.getBookings(
			RandomTestUtil.randomString());

		long totalCount = page.getTotalCount();

		Booking booking1 = testGetBookings_addBooking(randomBooking());

		Booking booking2 = testGetBookings_addBooking(randomBooking());

		page = bookingResource.getBookings(null);

		Assert.assertEquals(totalCount + 2, page.getTotalCount());

		assertContains(booking1, (List<Booking>)page.getItems());
		assertContains(booking2, (List<Booking>)page.getItems());
		assertValid(page, testGetBookings_getExpectedActions());
	}

	protected Map<String, Map<String, String>>
			testGetBookings_getExpectedActions()
		throws Exception {
	...
	protected Booking testGetBookings_addBooking(Booking booking)
		throws Exception {
	...
	@Test
	public void testGraphQLGetBookings() throws Exception {
	...
	protected void assertValid(Booking booking) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("dateOrder", additionalAssertFieldName)) {
			...
			if (Objects.equals("orderAdress", additionalAssertFieldName)) {
			...
			if (Objects.equals("vehicleId", additionalAssertFieldName)) {
	...
	protected void assertValid(
		Page<Booking> page, Map<String, Map<String, String>> expectedActions) {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					calendar.api.builder.dto.v1_0.Booking.class)) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("dateOrder", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						booking1.getDateOrder(), booking2.getDateOrder())) {
			...
			if (Objects.equals("orderAdress", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						booking1.getOrderAdress(), booking2.getOrderAdress())) {
			...
			if (Objects.equals("orderId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						booking1.getOrderId(), booking2.getOrderId())) {
			...
			if (Objects.equals("vehicleId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						booking1.getVehicleId(), booking2.getVehicleId())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("dateOrder")) {
			Object object = booking.getDateOrder();
		...
		if (entityFieldName.equals("endTime")) {
			Object object = booking.getEndTime();
		...
		if (entityFieldName.equals("orderAdress")) {
			Object object = booking.getOrderAdress();
		...
		if (entityFieldName.equals("orderId")) {
			sb.append(String.valueOf(booking.getOrderId()));

			return sb.toString();
		}

		if (entityFieldName.equals("startTime")) {
			Object object = booking.getStartTime();
		...
		if (entityFieldName.equals("vehicleId")) {
			sb.append(String.valueOf(booking.getVehicleId()));
	...
	protected Booking randomBooking() throws Exception {
		return new Booking() {
			{
				dateOrder = StringUtil.toLowerCase(
					RandomTestUtil.randomString());
				endTime = StringUtil.toLowerCase(RandomTestUtil.randomString());
				orderAdress = StringUtil.toLowerCase(
					RandomTestUtil.randomString());
				orderId = RandomTestUtil.randomInt();
				startTime = StringUtil.toLowerCase(
					RandomTestUtil.randomString());
				vehicleId = RandomTestUtil.randomInt();
			}
		};
	}
	...
	@Inject
	private calendar.api.builder.resource.v1_0.BookingResource _bookingResource;
